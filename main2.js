...
let input_submits = document.querySelector('.resumeGeneratbtn');
let conatiner = document.querySelector('.container');
let resume_generated_conatiner = document.querySelector('.resume12');
let resume_output = document.querySelector('#resume-output');
